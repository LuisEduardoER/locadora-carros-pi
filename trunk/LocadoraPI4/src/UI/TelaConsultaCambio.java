 ...
 * @author Rafael
 */
public class TelaConsultaCambio extends javax.swing.JFrame {

    /**
     * Creates new form TelaConsultaCambio
     */
    public TelaConsultaCambio() {
        initComponents();
        ...
        this.setTitle(Geral.getEmpresa() + " - CONSULTAR CÂMBIO");
    ...
    void carregaTabela(){
        ...
        ResultSet resultado = Conexao.buscaOutros(txtNome.getText(), "cambio", "nome");
        try {
        ...
        tbCambio.setModel(modeloTabela);
    }
    ...
    private void initComponents() {
        ...
        tbCambio = new javax.swing.JTable();
        ...
        tbCambio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        Conexao.excluirRegistro("cambio", id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaCambio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaCambio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbCambio;
