 ...
 * @author Rafael
 */
public class TelaConsultaCombustivel extends javax.swing.JFrame {

    /**
     * Creates new form TelaConsultaCombustivel
     */
    public TelaConsultaCombustivel() {
        ...
        this.setTitle(Geral.getEmpresa() + " - CONSULTAR COMBUSTÍVEL");
    ...
    private void initComponents() {
        ...
        tbCombustivel = new javax.swing.JTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaCombustivel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaCombustivel().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbCombustivel;
