...
public class TelaMenuRelatorios extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaMenuRelatorios
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaMenuRelatorios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaMenuRelatorios().setVisible(true);
            }
        });
    }
