 ...
 * @author Rafael
 */
public class TelaRelatorioCarrosAlugados extends javax.swing.JFrame {

    /**
     * Creates new form TelaRelatorioCarrosAlugados
     */
    public TelaRelatorioCarrosAlugados() {
        initComponents();
        ...
        this.setTitle(Geral.getEmpresa() + " - CARROS ALUGADOS");
    ...
    void carregaTabela(){
        ...
        ResultSet resultado = Conexao.buscaCarrosAluguel("C.modelo LIKE '%" + txtModelo.getText() + "%' AND placa LIKE '%" + txtPlaca.getText() + "%' AND (A.status_id = 1 OR A.status_id = 2)");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioCarrosAlugados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRelatorioCarrosAlugados().setVisible(true);
            }
        });
    }
