...
//                    formatter.format(resultado.getDate("data_entrega")),
    ...
    private void initComponents() {
        ...
        tbAluguel.getTableHeader().setResizingAllowed(false);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtCarro, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
        ...
        if(verificaStatusAluguel()){
            JOptionPane.showMessageDialog(null, "Esse alguel já foi finalizado");
        }
        else{
            String[] options = new String[] { "Sim", "Cancelar" };

            Object ret = JOptionPane.showOptionDialog(null, "Deseja finalizar esse Alguel?", "Confirmação",
