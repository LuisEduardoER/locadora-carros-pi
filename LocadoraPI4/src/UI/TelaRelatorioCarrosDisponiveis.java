 ...
 * @author Rafael
 */
public class TelaRelatorioCarrosDisponiveis extends javax.swing.JFrame {

    /**
     * Creates new form TelaRelatorioCarrosDisponiveis
     */
    public TelaRelatorioCarrosDisponiveis() {
        initComponents();
        carregaTabela();
        
        myInitComponents();
        
        this.setTitle(Geral.getEmpresa() + " - CARROS DISPONÍVEIS");
    ...
    void carregaTabela(){
        ...
        String[] colunasTabela = new String[]{"Código", "Modelo", "Placa"};  
        ...
        ResultSet resultado = Conexao.buscaCarrosAluguel("C.modelo LIKE '%" + txtModelo.getText() + "%' AND placa LIKE '%" + txtPlaca.getText() + "%' AND (A.status_id IS NULL OR A.status_id = 3)");
        try {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtPlaca, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioCarrosDisponiveis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRelatorioCarrosDisponiveis().setVisible(true);
            }
        });
    }
